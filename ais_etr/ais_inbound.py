...
def _model_demo_readiness_markdown(report: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "- It omits full meter numbers, PEANO lists, WebEx room ids, raw WebEx text, tokens, secrets, and customer identity.",
            "- AIS outage/restore remains the customer-facing truth source.",
...
def _shadow_demo_rehearsal_markdown(report: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "## Guardrails",
            "",
            "- This report omits full meter numbers, PEANO lists, WebEx room ids, raw WebEx text, tokens, secrets, and customer identity.",
