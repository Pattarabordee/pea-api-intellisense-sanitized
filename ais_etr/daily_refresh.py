...
def run_daily_shadow_refresh(
    ...
    *,
    ...
    owner_response_preflight_output: str | Path = "runtime/owner_response_preflight.csv",
    owner_response_preflight_markdown: str | Path = "runtime/owner_response_preflight.md",
    owner_response_readme_output: str | Path = "runtime/owner_responses/README.md",
    ...
    step(
        ...
        lambda: validate_owner_response_files(
            ...
            preflight_output=owner_response_preflight_output,
            preflight_markdown_output=owner_response_preflight_markdown,
            response_readme_output=owner_response_readme_output,
        ),
    )
    step(
    ...
    return {
        ...
        "key_outputs": {
            ...
            "owner_response_preflight": str(owner_response_preflight_markdown),
            "owner_response_readme": str(owner_response_readme_output),
...
def _intake_readme(root: Path) -> str:
    return "\n".join(
        [
            ...
            "- ห้ามใส่ token, room id, raw WebEx text, customer name หรือ PEANO list ใน report สำหรับผู้บริหาร",
            "",
            "## Output หลักหลังรัน",
            "",
