...
RUNTIME_ALLOWLIST = {
    ...
    "AI_COPILOT_NEXT_STEPS_ACTION_PLAN.MD",
    "AI_COPILOT_NEXT_STEPS_CONSULTATION_SUMMARY.MD",
    "AI_COPILOT_PRODUCTION_NEXT_STEPS_PROMPT.MD",
    "CHATGPT_COPILOT_SAFETY.MD",
    "CHATGPT_PRODUCTION_REVIEW_RESPONSE_STALL.MD",
    "CHATGPT_PRODUCTION_NEXT_STEPS_RESPONSE.MD",
    "CLAUDE_DESKTOP_OPUS48_PROMPT.MD",
    "CLAUDE_PRODUCTION_NEXT_STEPS_RESPONSE.MD",
    "GEMINI_PRODUCTION_NEXT_STEPS_RESPONSE.MD",
    "GO_NO_GO_SUMMARY.MD",
    "GREEN_GATE_TRACKER.MD",
    "PEA_API_INTELLISENSE_PITCH_ANSWERS.MD",
    "PEA_API_INTELLISENSE_TECHNICAL_BRIEF.MD",
    ...
    "PRODUCTION_CLOUD_REAL_HIT_STATUS.JSON",
    "PRODUCTION_CLOUD_REAL_HIT_STATUS.MD",
    "PRODUCTION_CLOUD_RENDER_BLUEPRINT.MD",
    "RENDER_CLOUD_SHADOW_DEPLOY_HANDOFF.MD",
    "RENDER_CLOUD_SHADOW_DEPLOY_STATUS.JSON",
    ...
    *,
    ...
    checks = [
        ...
        _prod_check(
            ...
            "Local QA, backup, restore, real-hit check, and privacy scan scripts are present.",
...
def _sanitize_text(text: str) -> tuple[str, int]:
    redactions = 0
    sanitized = text.replace("raw WebEx", "verbatim WebEx")
