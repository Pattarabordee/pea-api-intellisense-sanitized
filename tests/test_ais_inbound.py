        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                post_req = urllib.request.Request(
                    ...
                    method="POST",
                    headers={"Content-Type": "application/json", "X-API-Key": "pilot-key"},
                )
                ...
                cases = [
                    ...
                    (
                        urllib.request.Request(
                            ...
                            method="POST",
                            headers={"Content-Type": "text/plain", "X-API-Key": "pilot-key"},
                        ),
                        415,
                        "UNSUPPORTED_MEDIA_TYPE",
                    ),
                ...
                json.dumps(
                    {
                        "mode": "shadow",
                        "production_send": "blocked",
                        "primary_public_url": "https://example.loca.lt/api/v1/ais/outage-verifications",
                        "primary_health_url": "https://example.loca.lt/health",
                        "primary_health_smoke": "200_OK",
                    }
                ),
                encoding="utf-8",
                ...
                json.dumps(
                    {
                        "mode": "shadow",
                        "production_send": "blocked",
                        "public_url": "https://example.loca.lt/api/v1/ais/outage-verifications",
                        "health_url": "https://example.loca.lt/health",
                        "all_checks_ok": True,
...
def _seed_runtime(db_path: Path) -> None:
    ...
    match = MatchResult(
        matches=(CustomerMatch(customer="AIS", peano="1234567890", feeder="PFA03", match_level="cb"),),
        match_level="cb",
