Please switch to Chat/code mode first if the current UI is Claude Design.
Please use Claude Opus 4.8 for this review.

Then review this project as a strict external production architecture reviewer.
