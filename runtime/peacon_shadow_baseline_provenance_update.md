...
Prediction snapshot ถูกเก็บใน private operator ledger เท่านั้น ไม่ถูกใส่ใน callback/outbox และไม่ถูกส่งให้ลูกค้า การประเมิน MAE ในอนาคตจะใช้เฉพาะ snapshot ที่เกิดก่อน RESTORE และ clean AIS event-remaining truth หลังรวมเป็นเหตุการณ์อิสระอย่างน้อย 30 เหตุการณ์ ระบบยังอยู่ใน shadow mode และ `production_send=blocked`
